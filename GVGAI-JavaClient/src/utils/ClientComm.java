...
public class ClientComm {
    ...
    public void startComm()
    {
        ...
        try {
            ...
            System.out.println("Error aqui puto");
            io.logStackTrace(e);
        }
    }
    ...
    private void listen() throws IOException {
        ...
        while (line != null) {
            ...
            System.out.println("proccessed line");
...
//            io.writeToFile(sso.toString());
    ...
    private void startAgent()
    {
        ...
        {
            System.out.println("Otro Error puto! seguramente aqui acaba");
    ...
    private void init()
    {
        ...
        System.out.println("All good in init");
    }
